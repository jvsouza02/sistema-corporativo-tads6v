                                            ...
                                            <div class="card-body p-2 d-flex flex-column">
                                                ...
                                                <div class="mt-auto">
                                                    <div class="horarios-status"
                                                        id="status-{{ $barbearia->id_barbearia }}">
                                                        <span class="badge bg-success">Disponível</span>
                                                    </div>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-primary mt-2 btn-escolher-horario">
                                                        Escolher Horário
                                                    </button>
                                                </div>
                                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function buscarHorariosOcupados(barbeariaId, data) {
                ...
                try {
                    const response = await fetch(
                        `/api/barbearias/${barbeariaId}/horarios-ocupados?data=${data}`);
            ...
            async function abrirModalHorarios(card) {
                ...
                document.getElementById('modalDataAtual').textContent = formatarDataParaExibicao(
                    dataSelecionada);
