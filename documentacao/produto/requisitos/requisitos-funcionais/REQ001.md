...
**ESCOPO:** Registro dos atendimentos realizados pelos barbeiros, documentando os serviços executados, o valor pago e as observações relevantes, mantendo o histórico de cada cliente.  
**PROPÓSITO:** Permitir que o barbeiro registre as informações do atendimento, incluindo o serviço executado, o valor pago e observações, mantendo o histórico do cliente atualizado e apoiando o controle da barbearia.  
**ATOR:** Barbeiro  
...
- O serviço executado deve estar cadastrado e ativo no sistema.  

---

## PÓS-CONDIÇÕES
- O atendimento é registrado e vinculado ao cliente, ao barbeiro e ao serviço executado.  
- O **valor pago** é registrado, podendo ser informado manualmente ou herdado do valor padrão do serviço.  
- As informações passam a constar no histórico de atendimentos da barbearia.  
- O registro alimenta relatórios gerenciais e financeiros da barbearia.  
...
3. O barbeiro seleciona um agendamento e preenche as informações: tipo de serviço executado, observações sobre o cliente e **valor pago**.  
4. O barbeiro confirma clicando em **“Salvar”**.  
5. O sistema valida os dados inseridos.  
6. O sistema registra o atendimento e associa-o ao histórico do cliente, incluindo o **valor pago**.  
...
2. O sistema exibe todos os atendimentos anteriores, incluindo tipo de serviço, valor pago e observações registradas.  
