...
- Produto deve possuir nome, descrição, preço e quantidade registrada em mililitros (ml).

### PÓS-CONDIÇÕES
- Produto criado, editado ou removido.  
- Estoque atualizado após cadastros, edições, remoções ou reposições.  
- Quantidades disponíveis registradas e mantidas em ml.
...
### FLUXO DE EXCEÇÃO
- **E1 – Dados incompletos:** Sistema informa os dados faltantes.  
