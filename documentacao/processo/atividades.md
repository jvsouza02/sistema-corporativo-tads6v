...
**[Analista de Negócio (AN)](papeis.md#analista-de-negocio-an)**.
...
| :----------- | :------------------------------------------------------------------------------------------------------ |
| **Entradas** | Solicitações de Clientes, demandas de mercado, estratégias de negócio.                                  |
| **Saídas**   | Declaração de Escopo, Requisitos Iniciais, **[Documento de Visão](artefatos.md#1-documento-de-visao)**. |
...
| Elemento     | Descrição                                                                                                                  |
| :----------- | :------------------------------------------------------------------------------------------------------------------------- |
| **Entradas** | **[Documento de Visão](artefatos.md#1-documento-de-visao)**, Declaração de Escopo, Modelo de Domínio / Diagrama de Classes |
| **Saídas**   | **[História de Usuário](artefatos.md#2-hist%C3%B3ria-de-usu%C3%A1rio)**                                                    |

### Tarefas principais

1. Redigir Histórias de Usuário no formato: *Como um / Eu desejo / Para que*.
2. Definir Critérios de Aceitação (Dado / Quando / Então) para cada história.
3. Mapear requisitos para elementos do Diagrama de Classes (entidades/atributos/relacionamentos).
4. Estimar esforço inicial e indicar dependências para a EAP.
...
A atividade **Codificar** corresponde à implementação. Nessa fase, o time desenvolve e integra o **código-fonte**, transformando o **[História de Usuário](artefatos.md#2-hist%C3%B3ria-de-usu%C3%A1rio)** em um **[Produto Executável](artefatos.md#3-produto-software-execut%C3%A1vel)** de acordo com os padrões de qualidade. Além disso, o desenvolvedor é responsável pela criação e manutenção dos **testes unitários**, garantindo que cada módulo do código funcione de forma isolada e conforme especificado.
...
| Elemento     | Descrição                                                                                                                  |
| :----------- | :------------------------------------------------------------------------------------------------------------------------- |
| **Entradas** | **[História de Usuário](artefatos.md#2-hist%C3%B3ria-de-usu%C3%A1rio)** com Critérios de Aceitação, Requisitos e Diagramas |
| **Saídas**   | **[Produto Executável](artefatos.md#3-produto-software-execut%C3%A1vel)**, Código-fonte, Testes Unitários aprovados.       |
...
2. **Implementação:** Escrever o código de acordo com as histórias de usuário.
3. **Integração:** Unir os módulos ao sistema e resolver dependências.
4. **Elaboração de Testes Unitários:** Desenvolver testes automatizados para validar o comportamento esperado de classes, funções e métodos de forma isolada.
5. **Entrega do Produto:** Compilar e gerar o **[Produto Executável](artefatos.md#3-produto-software-execut%C3%A1vel)** para testes.
...
| Elemento     | Descrição                                                                                                         |
| :----------- | :---------------------------------------------------------------------------------------------------------------- |
| **Entradas** | **[História de Usuário](artefatos.md#2-hist%C3%B3ria-de-usu%C3%A1rio)** com Critérios de Aceitação, Documentação. |
| **Saídas**   | Aprovação ou devolução com comentários,  observações/pendências documentadas.                                     |
...
*Observação:* este documento descreve as atividades do processo e pode ser atualizado com checklists ou templates anexos para cada tarefa conforme a necessidade de governança do projeto.
